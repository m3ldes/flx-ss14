...
alert-level-octarine-announcement = Катастрофическое ноосферное событие угрожает поглотить реальное пространство. Экипаж станции должен сдержать событие, если это возможно, или эвакуироваться.
alert-level-octarine-instructions = Членам экипажа рекомендуется слушать руководителей персонала для получения дополнительной информации.