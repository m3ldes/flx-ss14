# General
monument-interface-title = Памятник
...
monument-interface-entropy-crew-convert-title = Обращенных до следующей Стадии:
...
monument-interface-influences-owned = Приобретено
