...
game-ticker-player-join-game-message = Добро пожаловать на FLX: Cosmi Station! Чтобы зайти на наш Discord-сервер, нажмите на соответствующую кнопку в лобби или лаунчере игры. Если вы играете впервые и ещё не ознакомились с правилами, обязательно сделайте это, и не бойтесь спрашивать в AHelp обо всём, что вам нужно.
game-ticker-get-info-text =
    Добро пожаловать на [color=orange]FLX: Cosmi Station![/color]
...
game-ticker-get-info-preround-text =
    Привет и добро пожаловать на [color=orange]FLX: Cosmi Station![/color]
    Текущий раунд: [color=white]#{ $roundId }[/color]
